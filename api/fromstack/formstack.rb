  ...
  resource :forms do
    ...
    post '/to-pdf' do
      ...
      form = {
          ...
          scar_treatment: CheckboxListDecoder.checked?(params['Diagnosis'], 'Scar_Treatment'),
          post_surgery_scar: CheckboxListDecoder.checked?(params['Diagnosis'], 'Post Surgery Scar'),
          diagnosis_other: params['Other diagnosis'],
          ftccb_1: CheckboxListDecoder.checked?('Formula','FTCCB - Flurbiprofen 20%, Tramadol 5%, Clonidine 0.2%, Cyclobenzaprine 4%, Bupivacaine 1%'),
          ftccb_2: CheckboxListDecoder.checked?('Formula','FTCCB - Flurbiprofen 20%, Tramadol 5%, Clonidine 0.2%, Cyclobenzaprine 4%, Bupivacaine 3%'),
          scra: CheckboxListDecoder.checked?('Formula','SCRA – (Keloids & Hyphertrophic) Tamaxifen Citrate 0.1%, Tranilast 1%, Lipoic Acid 0.5%, Fluticasone 1%, Collgenase 350 U/GM Hyaluronic Acid 0.1% PRACASIL PLUS'),
          away: CheckboxListDecoder.checked?('Formula','AWAY – (new, old, keloid scars) Fluticasone 1%, Tretinoin 0.05% Pentoxifylline 3%, PRACASIL PLUS'),
          fade: CheckboxListDecoder.checked?('Formula','FADE – (dark or hyperpigmented scars) Fluticasone 1%, Hydroquinone 8%, PRACASIL PLUS'),
          sugi: CheckboxListDecoder.checked?('Formula','SUGI – (post surgical) Mupirocin 4%, Verapamil 6%, Phenytoin 2%, Betamethasone 0.1% PRACASIL PLUS'),
